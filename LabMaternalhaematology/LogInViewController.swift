...
//        
//        //template for entry
//        newEntry2.setValue("2", forKey: "caseNumber");
//        newEntry2.setValue("20week G1P0 with hepatospleenomegaly", forKey: "caseSummary");
//        newEntry2.setValue("A 22yo G1P0 female presented to ER with amenorrhea, pyrexia, anaemia, and a rash over her limbs.\n\nExamination revealed pallor, peteciae,  hepto-spleenomegaly,  and a enlarged uterus corresponding to appox 20weeks of gestation (confirmed via ultra sound).\n\nPatient had a miscarriage at 12 weeks one year previously.\nNo significant family or personal history noted.", forKey: "history");
//        newEntry2.setValue("F", forKey: "sex");
//        newEntry2.setValue("22yo", forKey: "age");
//        newEntry2.setValue("N/A", forKey: "apgar");
//        newEntry2.setValue("39", forKey: "temperature");
//        newEntry2.setValue("2.4 - N", forKey: "wcc");
//        newEntry2.setValue("48 - L", forKey: "hgb");
//        newEntry2.setValue("26 - N", forKey: "mch");
//        newEntry2.setValue("355 -N", forKey: "mchc");
//        newEntry2.setValue("100 - H", forKey: "mcv");
//        newEntry2.setValue("8 - L", forKey: "plts");
//        newEntry2.setValue("key: N = Normal\nH= High\nL = Low\n SI units used.\nUrea 16 - H \nCreatinine  42 umol/L – N\nAST 140 U/dl - H\nALP 676 U/dl - H\nLDH 1083 mg/dl – H\nTBIL Bil 1.31mg/dl - H", forKey: "others");
//        newEntry2.setValue("Romanowsky x100", forKey: "q1ImageTitleA");
//        newEntry2.setValue("Romanowsky x100", forKey: "q1ImageTitleB");
//        newEntry2.setValue("Romanowsky x100", forKey: "q1ImageTitleC");
//        newEntry2.setValue("Romanowsky x100", forKey: "q1ImageTitleD");
//        newEntry2.setValue("case2a.jpg", forKey: "question1Image1");
//        newEntry2.setValue("case2b.jpg", forKey: "question1Image2");
//        newEntry2.setValue("case2c.jpg", forKey: "question1Image3");
//        newEntry2.setValue("case2d.jpg", forKey: "question1Image4");
//        newEntry2.setValue("Megakaryoblasts", forKey: "question_image1OptionA");
//        newEntry2.setValue("Monoblasts", forKey: "question_image1OptionB");
//        newEntry2.setValue("Erythroblasts", forKey: "question_image1OptionC");
//        newEntry2.setValue("Blasts", forKey: "question_image1OptionD");
//        newEntry2.setValue("D", forKey: "q1Answer");
//        
//        
//        newEntry2.setValue("Select most appropriate tests", forKey: "theQuestion2");
//        
//        newEntry2.setValue("ASXL1-TET2 mutations", forKey: "q2OptionA");
//        newEntry2.setValue("B12 and Folate", forKey: "q2OptionB");
//        newEntry2.setValue("BM Biopsy + Flow", forKey: "q2OptionC");
//        newEntry2.setValue("JAK2-BCR/ABL gene", forKey: "q2OptionD");
//        newEntry2.setValue("Negative. \nThese RNA splicing mutations are generally used in investigation of myelodysplastic syndromes", forKey: "q2OptionADialog");
//        newEntry2.setValue("Folate 8.56 – Low, B12 Normal", forKey: "q2OptionBDialog");
//        newEntry2.setValue("BM examination revealed 75% non-erythoid blasts with high/nuclear cytoplasmic ratio, which demonstrated positivity with Sudan Black and Myeloperoxidase and were negative for periodic acid-Schiff.\n\nBlasts were of Type 1 (agruanlar) and Type II (granular). \nApproximately 10% of remaining non-erythoid cells were maturing granulocytes. \nFlow cytometry analysis with a Beckman Coulter Cytomics F500 showed the blasts population was positive for CD13, CD33, CD34 and CD11/CD14/36/64/68 negative.\n\nCytogenetic’s revealed a normal XX type.", forKey: "q2OptionCDialog");
...
//        
//        newEntry2.setValue("C", forKey: "question2Answer");
//        
//        newEntry2.setValue("What is the Diagnosis?", forKey: "theQuestion3");
//        newEntry2.setValue("Pure Erythroid Leuk", forKey: "question3OptionA");
//        newEntry2.setValue("AML –M5 Monblastic", forKey: "question3OptionB");
//        newEntry2.setValue("AML – M2", forKey: "question3OptionC");
//        newEntry2.setValue("Acute Basophilic Luek", forKey: "question3OptionD");
//        
//        newEntry2.setValue("C", forKey: "question3Answer");
