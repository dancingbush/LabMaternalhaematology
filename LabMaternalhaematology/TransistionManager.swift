...
//
//  Created by Ciaran Mooney on 10/04/2015.
//  Copyright (c) 2015 Ciaran Mooney. All rights reserved.
//

/* Use objects of this class to override defulat 
transistion animations between VC's in prepare for segue fucntions. Seperate approah req fro tabbar controllers
*/

import UIKit

class TransistionManager: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate {
