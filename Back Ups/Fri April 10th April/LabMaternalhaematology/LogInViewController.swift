...
//        //template for entry
         ...
         var newEntry3 = NSEntityDescription.insertNewObjectForEntityForName("Case", inManagedObjectContext: context) as NSManagedObject; // enity = the table name whoch is TableName in this case
